...
//     $ip = '49.36.83.154'; // This is static ip address
            ...
            $query = @unserialize(@file_get_contents('http://ip-api.com/php/' . $ip, false, stream_context_create(['http' => ['timeout' => 3]])));
        ...
        if($user->type =='company' || $user->type =='client' || $user->type =='super admin')
        {
