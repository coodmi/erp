...
Route::get('/vclients', function (Request $request) {
    ...
    if($printclient_id){
        return view('vclients.moneyreceipts');
    }else{
...
Route::get('/agents', function (Request $request) {
    ...
    $invoice = $request->input('invoiceof');
    $moneyrecipt = $request->input('moneyrecipt');
    $receipt = $request->input('receiptof');
    
    if($moneyrecipt){
        return view('agents.moneyreceipts');
    }else{
        // Check the values of the URL parameters
        if ($agent) { 
            return view('agents.clients');
        } elseif ($invoice) { 
            return view('agents.invoices');
        } elseif ($receipt) { 
            return view('agents.receipt');
        } else {
            return view('agents.index');
        }
    }
...
Route::middleware('web')->get('/ledger/infoedit/{id}', 'LedgerController@editinfo')->name('ledger.editinfo');
Route::middleware('web')->post('/ledgerinfo/update', 'LedgerController@updateinfo')->name('ledger.updateinfo');
...
Route::get('/setcountry/{country}', 'CountryController@setid');
Route::get('/setstatus/{status}', 'CountryController@setstatus');
