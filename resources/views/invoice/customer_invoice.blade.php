...
<head>
    ...
    <title>{{(Utility::companyData($invoice->created_by,'title_text')) ? Utility::companyData($invoice->created_by,'title_text') : config('app.name', 'Alphainno ERP')}} - {{__('Invoice')}}</title>
                      ...
                      <div class="card bg-none card-box">
                          <section class="nav-tabs p-2">
                              @if ((isset($company_payment_setting['is_stripe_enabled']) && $company_payment_setting['is_stripe_enabled'] == 'on') ||
                                   ...
                                   (isset($company_payment_setting['is_nepalste_enabled']) && $company_payment_setting['is_nepalste_enabled'] == 'on') ||
                                              ...
                                              <div class="row mt-2">
                                                  <div class="form-group col-md-12">
                                                      ...
                                                      <div class="input-group">
                                                          <span class="input-group-prepend"><span class="input-group-text">{{$settings['site_currency'] }}</span></span>
                                                  ...
                                                  <div class="form-group col-md-12">
                                                      ...
                                                      <div class="input-group">
                                                        <span class="input-group-prepend">
                                                            ...
                                                            <span class="input-group-text">{{ $settings['site_currency'] }}</span>
                                                        </span>
