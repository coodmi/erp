...
<head>
    ...
    <title>{{(Utility::companyData($proposal->created_by,'title_text')) ? Utility::companyData($proposal->created_by,'title_text') : config('app.name', 'Alphainno ERP')}} - {{__('Proposal')}}</title>
