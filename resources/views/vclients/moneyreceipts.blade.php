@php
    ...
    $clid = isset($_GET['printclient_id']) ? intval($_GET['printclient_id']) : null;
    $results = [];
    ...
    if (!empty($receipt_logo)) {
        $logoImg = \App\Models\Utility::printFileUrl('receipt_logo', $receipt_logo);
    } elseif (!empty($invoice_logo)) {
        $logoImg = \App\Models\Utility::printFileUrl('invoice_logo', $invoice_logo);
    } else {
...
<head>
    ...
    <style>
        * { box-sizing:border-box; margin:0; padding:0; }
        ...
        .receipt-meta-item { display:flex; flex-direction:column; gap:2px; }
        .receipt-meta-item .lbl { font-size:.68rem; font-weight:800; color:#94a3b8; text-transform:uppercase; letter-spacing:.07em; }
        ...
        .services-table tbody tr:hover td { background:#f8fafc; }
        ...
        .price-input:focus { background:#f0fdf4; border-radius:6px; padding:2px 6px; }
        ...
        .totals-row:last-child { border-bottom:0; padding-top:10px; margin-top:4px; }
        .totals-row .t-lbl { color:#64748b; font-weight:600; }
        .totals-row .t-val { font-weight:800; color:#0f172a; }
        .totals-row.total-final .t-lbl { font-size:.95rem; color:#0f172a; font-weight:800; }
        .totals-row.total-final .t-val { font-size:1.1rem; color:#2563eb; }
        .totals-row.due-row .t-val { color:#e11d48; }
        ...
        .totals-input:focus { background:#eff6ff; border-radius:6px; padding:2px 6px; }
        ...
        @media(max-width:600px){
            ...
            .receipt-header { flex-direction:column; gap:12px; text-align:center; }
            .receipt-title { text-align:center; }
            .receipt-header img { height:40px; }
        }
    </style>
</head>
<body>
<div class="screen-wrap">
    ...
    <div class="screen-actions">
        <button class="btn-print secondary" onclick="window.history.back()">
            ← Back
        </button>
    ...
    <div class="receipt" id="receipt-area">
        ...
        <div class="receipt-meta">
            ...
            <div class="receipt-meta-item">
                ...
                <span class="val">{{ $client->status ?? '—' }}</span>
            </div>
            @endif
        </div>
        ...
        <div class="receipt-body">
            ...
            <div class="bill-section">
                ...
                <div class="bill-box">
                    ...
                    <p>
                        ...
                        Ticket: <strong>{{ $client->isTicket ? 'Yes' : 'No' }}</strong>
                    </p>
                </div>
            </div>
            ...
            <div class="totals-wrap">
                <div class="totals-box">
                    ...
                    <div class="totals-row due-row">
                        ...
                        <span class="t-val"><input type="number" class="totals-input" id="due" value="{{ intval($client->amount_due ?? 0) }}" readonly style="color:#e11d48;"></span>
                    </div>
            ...
            @else
                <div style="text-align:center;padding:48px;color:#94a3b8;">
                    <p style="font-size:1rem;">No client data found.</p>
                </div>
            @endif
        </div>
