@php
    ...
    $clid = isset($_GET['printclient_id']) ? $_GET['printclient_id'] : null;
    $results = [];
    $countries = [];
        ...
        <div class="bodydata" style="height:810px;">
            <div class="row mb-4 p-4">
                ...
                <div class="col-md-6 text-end"> 
                    <p style="font-size: 16px;padding-bottom: 6px;">Invoice Number: <strong>876543</strong></p>
            ...
            <div class="row p-4">
                ...
                <div class="col-md-6 text-end">
                    ...
                    <h5>Paid: 
                        <strong> 
                            <input type="number" name="paid"  onkeyup="calculation()"  value="{{intval($results[0]->amount_paid)}}" id="paid" style="border: none;text-align: right;">
                        </strong>
                    </h5>
                    <hr>
                    <h5>Due: 
                        <strong> 
                            <input type="number" name="due" value="{{intval($results[0]->amount_due)}}" id="due" style="border: none;text-align: right;">
                        </strong>
                    </h5>
                </div>
            </div>
        ...
        <div class="row  px-4 py-2 pt-3" style="background: #044fa1;">
            <div class="col-5">
                <div class="company-details">
                    <img src="https://erp.erazehanintl.com/storage/app/public/uploads/logo//logo-dark.png" alt="Eraz-ehan Logo" style="border-radius:6px;width:130px;height: 60px;">
                    <p class="pt-1" style="font-size: 20px;color: white;"><strong>Eraz-ehan Limited</strong></p>
